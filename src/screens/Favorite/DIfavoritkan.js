...
export default function DIfavoritkan() {
  ...
  return (
    <ScrollView style={{flex: 1}}>
      <View style={styles.bodyImg}>
        <Gap height={10} />
        <Image
          source={images.Img_DIfavoritkan}
          style={{height: 236, width: 236}}
        />
        <Text style={styles.TextTitle}>Belum ada kos dIfavoritkan</Text>
      </View>
      <Gap height={13} />
      ...
      <ScrollView
        ...
        style={{flexDirection: 'row'}}>
        <View style={styles.textTitleContent}>
          <Text style={styles.TxtContentFavorite}>Baru kamu lihat </Text>
          <Gap height={8} />
          <View style={styles.ViewBodyKost}>
            {/* Img pembukaan */}
            <Image
